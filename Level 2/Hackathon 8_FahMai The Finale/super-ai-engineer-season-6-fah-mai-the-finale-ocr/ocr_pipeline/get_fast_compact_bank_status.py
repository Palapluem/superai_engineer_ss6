#!/usr/bin/env python3
"""Report checkpoint progress for the compact operating-statement fast path."""
...
from run_fast_compact_bank_crop_ocr import CHECKPOINT_VERSION, compact_render_groups, flatten_slots
