...
The floor prevents clear high-risk/fall-like training windows from being averaged down when only one component, such as `GSI` or `fcri`, is strongly abnormal.
